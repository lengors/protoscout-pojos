...
class ScraperSpecificationReturnExtractDetailDeserializerTest
    extends InferenceDeserializerTestTemplate<ScraperSpecificationReturnExtractDetail> {
  /**
   * Initializes test suite with for {@link ScraperSpecificationReturnExtractDetail} base type.
   */
  ScraperSpecificationReturnExtractDetailDeserializerTest() {
    super(ScraperSpecificationReturnExtractDetail.class);
  }
  ...
  void shouldCorrectlyDeserializeReturnDetail(
      ...
      final Class<? extends ScraperSpecificationReturnExtractDetail> expectedType) throws IOException {
